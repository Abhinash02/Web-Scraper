...
// import { Menu, BookOpen, Bookmark, LogOut, User, LogIn, UserPlus } from "lucide-react";
...
//           {isAuthenticated ? (
//             <>
//               <div className="hidden items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-medium text-slate-700 sm:flex">
